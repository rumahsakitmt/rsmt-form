...
export default async function TemplateFormPage({ params }: Props) {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center  p-4 font-sans text-sm relative">
            <div className="absolute top-8 left-8 z-10">
                <Link
                    href="/admin/templates"
                    className="text-academic-black font-bold uppercase tracking-wider text-[11px] flex items-center gap-2"
                >
