                ...
                <div className="flex flex-col gap-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <Input required type="text" value={room} onChange={(e) => setRoom(e.target.value)} className="w-full bg-transparent border-b-2 border-academic-black p-3 text-academic-black font-bold uppercase focus:border-academic-green outline-none transition-colors border-t-0 border-l-0 border-r-0 rounded-none h-auto ring-0 focus-visible:ring-0 focus-visible:border-academic-green shadow-none" placeholder="e.g. UP3 BANTEN UTARA" />
                        </div>
                        <div>
                            ...
                            <Select value={theme} onValueChange={(val) => setTheme(val)}>
                                <SelectTrigger className="w-full bg-transparent border-b-2 border-academic-black p-3 text-academic-black font-bold uppercase outline-none cursor-pointer border-t-0 border-l-0 border-r-0 rounded-none h-auto ring-0 focus:ring-0 focus:border-academic-green shadow-none">
                                    <SelectValue />
                                </SelectTrigger>
                                <SelectContent className="bg-academic-white border-academic-black rounded-none shadow-[4px_4px_0px_#111111]">
                                    <SelectItem value="light" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">Light</SelectItem>
                                    <SelectItem value="dark" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">Dark</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                        <div>
                            ...
                            <Select value={status} onValueChange={(val) => setStatus(val)}>
                                ...
                                <SelectContent className="bg-academic-white border-academic-black rounded-none shadow-[4px_4px_0px_#111111]">
                                    <SelectItem value="ACTIVE" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">ACTIVE</SelectItem>
                                    <SelectItem value="DRAFT" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">DRAFT</SelectItem>
                                    <SelectItem value="LOCKED" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">LOCKED</SelectItem>
                                    <SelectItem value="REVIEW" className="focus:bg-academic-green focus:text-academic-black text-xs font-bold uppercase tracking-wider cursor-pointer">REVIEW</SelectItem>
                                </SelectContent>
                            </Select>
                        </div>
                    </div>
                    ...
                    <div className="border border-academic-black bg-academic-green p-4 shadow-[4px_4px_0px_#111111]">
                        ...
                        <Input type="file" accept=".docx" onChange={handleFileChange} className="w-full bg-academic-white border border-academic-black p-3 text-academic-black font-mono text-xs focus:outline-none file:mr-4 file:py-2 file:px-4 file:rounded-none file:border file:border-academic-black file:bg-academic-black file:text-academic-white file:font-bold file:uppercase file:text-[10px] file:tracking-widest cursor-pointer hover:file:bg-academic-white hover:file:text-academic-black file:transition-colors h-auto rounded-none ring-0 focus-visible:ring-0 shadow-none" />
