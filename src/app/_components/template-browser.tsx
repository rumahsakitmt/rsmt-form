...
export function TemplateBrowser() {
  ...
  return (
    <main className="flex h-dvh w-full flex-col overflow-hidden bg-black font-sans text-sm md:flex-row md:p-[2px]">
      ...
      {/* Middle Grid */}
      <section
        className={`${isMobileMenuOpen ? "hidden" : "block"} relative flex-1 overflow-y-auto bg-black px-[2px] pb-[2px] md:block md:pb-0`}
      >
          ...
          <div className="grid h-auto min-h-full grid-cols-1 gap-[2px] md:grid-cols-2 lg:grid-cols-3">
            {filteredCards.map((card) => (
              <div
                ...
                key={card.id}
                className={`group relative flex aspect-square cursor-pointer flex-col p-6 transition-opacity hover:opacity-90 ${
                  card.theme === "dark"
              ...
              >
                <div
                  className={`flex justify-between text-[10px] font-bold tracking-wider uppercase ${
